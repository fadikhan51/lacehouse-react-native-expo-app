    ...
    return (
        <View style={styles.screenContainer}>
            ...
            <ScrollView contentContainerStyle={styles.container}>
                ...
                >
                    <Text style={styles.boxTitle}>Add Product</Text>
                    <Text style={styles.boxText}>Create new products for inventory</Text>
                </TouchableOpacity>
                ...
                >
                    <Text style={styles.boxTitle}>Modify Product</Text>
                    <Text style={styles.boxText}>Update or delete existing products</Text>
                </TouchableOpacity>

                <TouchableOpacity
                    style={styles.box}
                    onPress={() => navigation.navigate('StockInventory')}
                >
                    <Text style={styles.boxTitle}>Stock Inventory</Text>
                    <Text style={styles.boxText}>Check remaining product quantities</Text>
                </TouchableOpacity>
                ...
                >
                    <Text style={styles.boxTitle}>Back to Admin</Text>
                    <Text style={styles.boxText}>Return to main admin page</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    );
